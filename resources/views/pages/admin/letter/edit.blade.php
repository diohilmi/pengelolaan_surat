                    ...
                    <div class="col-lg-7">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    <label for="letter_content" class="col-sm-3 col-form-label">Isi</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('letter_content') is-invalid @enderror" value="{{ $item->letter_content }}" name="letter_content" placeholder="Nomor Surat.." required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    <label for="letter_subject" class="col-sm-3 col-form-label">Subject</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('letter_subject') is-invalid @enderror" value="{{ $item->letter_subject }}" name="letter_subject" placeholder="Nomor Surat.." required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                       <input type="text" class="form-control @error('sender') is-invalid @enderror" value="{{ $item->sender }}" name="sender" placeholder="Pengirim" required>
                                    </div>
                                    @error('sender')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
                    ...
                    <div class="card mb-4">
                        @foreach ($files as $file)
                            <div class="card-header">
                                Attachment Surat - {{ $file->file_name }} <br>
                                <a href="{{ asset('attachments/'.$file->file_name) }}" class="btn btn-sm btn-primary">
                                    <i class="fa fa-download" aria-hidden="true"></i>
                                </a>
                                <a href="{{ route('delete-file', $file->id) }}" class="btn btn-sm btn-danger">
