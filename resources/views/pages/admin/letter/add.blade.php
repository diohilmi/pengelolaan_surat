...
@section('container')
    <main>
        ...
        <div class="container-fluid px-4">
            ...
            @endif
            <form action="{{ route('add-surat') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row gx-4">
                    <div class="col-lg-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="8" class="form-control @error('letter_content') is-invalid @enderror" name="letter_content" placeholder="letter_content" required>{{ old('isi') }}</textarea>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('letter_subject') is-invalid @enderror" value="{{ old('subject') }}" name="letter_subject" placeholder="letter_subject" required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('letter_date') is-invalid @enderror" value="{{ old('tanggal') }}" name="letter_date" required>
                                    </div>
                                    @error('letter_date')
                                        <div class="invalid-feedback">
                                            {{ $message; }}
